...
;(function(window) {
	...
	function Slideshow(el, options) {
		...
		this.Maindashboard_nav = this.el.querySelector('.Maindashboard_nav');
		// the navigation controls/anchors
		this.navCtrls = [].slice.call(this.Maindashboard_nav.querySelectorAll('.Maindashboard_nav__item'));
		// the titles
